<template lang="pug">
  .image-carousel(:class="{'image-carousel--vertical':(mode==='vertical')}"
    @mouseover="suspendAutoSlide=true" 
    @mouseout="suspendAutoSlide=false"
    )
    .image-carousel__previous(@click="checkPrevious" v-if="!(showSize>images.length)")
      img(src="./img/arrow.png")
    .image-carousel__image-list
      .image-carousel__virtual-list(ref="vlist" @click="handleClick")
    .image-carousel__next(@click="checkNext"  v-if="!(showSize>images.length)")
      img(src="./img/arrow.png")
</template>
<script>
export default {
